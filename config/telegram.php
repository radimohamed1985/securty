...
use App\Telegram\Commands\Admin\GenerateKeyCommand;
use App\Telegram\Commands\Admin\GenerateTrailKeyCommand;
...
use App\Telegram\Commands\ValidateCommand;
    ...
    */
    'bots'                         => [
        'mybot' => [
            ...
            'webhook_url_hash'    => env('TELEGRAM_WEBHOOK_URL_HASH'),
            'commands'            => [
                StartCommand::class,
                SubscribeCommand::class,
                ValidateCommand::class,
                GenerateKeyCommand::class,
                GenerateTrailKeyCommand::class,
                MainFormsCommand::class,
                FormCommand::class,
